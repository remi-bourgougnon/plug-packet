jQuery(document).ready(function($) {
    jQuery(".plp-install-pack-button").click(function(){ //when one of the plugin packs button is clicked, the function executes
        ...
        jQuery.post(ajaxurl, { action: "install_and_activate_pack_plugins", data: data}, function() { //uses ajax to execute the 'plugin_pack_installer' function from the admin.php page. It also sends button class retrieved earlier
